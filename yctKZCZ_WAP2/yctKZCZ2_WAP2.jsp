...
<%
   //System.out.println("羊城通自动充值yctKZCZ2_WAP2.....");
...
%>
	  <form method='post' action='/GZMBank/yctKZCZ_WAP2/yctKZCZ3_WAP2.jsp'>
         <h4>请输入相应签约信息</h4>
         <h4>用户姓名:</h4>
         ...
         <h4>羊城通卡号:</h4>
         <input type='text' name='yctcdno' style="-wap-input-format:'*N'; -wap-input-required: 'true'"  minlength='8' maxlength='10' size='10' />
