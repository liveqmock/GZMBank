...
<%
   //System.out.println("羊城通自动充值yctKZCZ6_WAP2.....");
   ...
   gzLog.Write("羊城通自动充值yctKZCZ6_WAP2.....\n");
...
<%
	...
	//[|bocom_mid|biz_id,25|biz_step_id,2|sign_flag,0|inst_no,交通银行|live_flag,1|tran_flag,1|bank_acc,6222600710004835700|paper_no,1440103198503131815|cust_name,张嘉骏|sex_code,0|phone_no,|mobile_no,13632256848|post_no,|address,|email,|card1,0257407740|PSWD,509429|card2,|card3,|card4,|limite,000000005000|frequence,D001|
      String    sendContext = "biz_id,25|i_biz_step_id,2|sign_flag,4|inst_no,交通银行|live_flag,1|tran_flag,1|bank_acc,"+ cdno.trim() + "|paper_no,"+sInfo[4].trim()+sInfo[1].trim() + "|cust_name,"+sInfo[0].trim()+"|sex_code,"+sInfo[2].trim()+"|phone_no,|mobile_no,"+sMobile+"|post_no,|address,|email,|card1,"+sInfo[3].trim()+"|PSWD,"+plantPwd+"|card2,|card3,|card4,|limite,000000005000|frequence,D001|";
