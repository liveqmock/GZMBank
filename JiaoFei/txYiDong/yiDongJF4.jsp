...
<%
  ...
  //	java.security.Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
	...
	String sendContext = "biz_id,7|biz_step_id,2|CDNO,"+cdno+"|PSWD,"+plantPwd+"|CTSQ,"+sjhm+fwhm+"|AMT1,"+AMT1+"|TXNSRC,MB441|";
	String sendContext1 = "biz_id,7|biz_step_id,2|CDNO,"+cdno+"|PSWD,******|CTSQ,"+sjhm+fwhm+"|AMT1,"+AMT1+"|TXNSRC,MB441|";
	gzLog.Write("卡号："+cdno+"手机号："+sjNo+"\n发送报文为："+sendContext1);
...
%>
	...
	<br/>
	<form method='post' action='/GZMBank/JiaoFei/txYiDong/yiDongJF4.jsp'> 
	<%
