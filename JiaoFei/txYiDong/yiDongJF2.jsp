...
<%
	...
	String sendContext = "biz_id,7|biz_step_id,1|CDNO,"+cdno+"|PSWD,"+fwhm+"|CTSQ,"+sjhm+"|TXNSRC,MB441|";
	gzLog.Write("卡号："+cdno+"手机号："+sjNo+"\n发送报文为：biz_id,7|biz_step_id,1|CDNO,"+cdno+"|PSWD,XXXXXX"+"|CTSQ,"+sjhm+"|TXNSRC,MB441|");
...
%>
	<form method='post' action='/GZMBank/JiaoFei/txYiDong/yiDongJF3.jsp'> 
